...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <span className="absolute left-[40%] hidden -translate-x-1/2 text-sm font-semibold text-[#17876D] peer-data-[state=checked]/thumb:block">
      Bridge
    </span>

    <span className="absolute left-[63%] block -translate-x-1/2 text-sm font-semibold text-[#17876D] peer-data-[state=checked]/thumb:hidden">
      Starknet
    </span>
  </SwitchPrimitives.Root>
));
