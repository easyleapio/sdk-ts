...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <span className="easyleap-absolute easyleap-left-[15%] easyleap-hidden easyleap-text-sm !easyleap-text-white easyleap-font-semibold peer-data-[state=checked]/thumb:easyleap-block">
      Bridge
    </span>

    <span className="easyleap-absolute easyleap-left-[33%] easyleap-block easyleap-text-sm !easyleap-text-white easyleap-font-semibold peer-data-[state=checked]/thumb:easyleap-hidden">
      Starknet
    </span>
  </SwitchPrimitives.Root>
));
