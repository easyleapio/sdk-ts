...
export function useBalance(props: UseBalanceProps): UseBalanceResult {
    ...
    useEffect(() => {
        console.log("useBalance", {result, mode, addressDestination, source, resultWagma, addressSource, error: result.error, sourceTokenAddr: sourceTokenInfo?.l1_token_address});
    }, [result]);
    return result;
}